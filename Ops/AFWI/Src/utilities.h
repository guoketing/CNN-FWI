...
__global__ void propagate_adj(float *d_un, float *d_uc, float *d_up,
	float *d_phiz, float *d_phix, float *d_Vp, float *d_sigma_z, float *d_sigma_x, \
...
__global__ void exchange_wavefield(float *d_un, float *d_uc, float *d_up, \
	float *d_phiz_un, float *d_phiz_uc, float *d_phix_un, float *d_phix_uc, int nz);
