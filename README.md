...
CNN-EFWI is a tool for elastic full waveform inversion at the framework of PyTorch. 
...
dz_orig = 80
dx_orig = 80
nz_orig = 188  # original scale
nx_orig = 438  # original scale
...
ind_src_x = np.arange(0, nx, 30).astype(int)
...
wavelet = extract_data(wavelet)[0] * 1000
